...
export const ChainInfo: FC = () => {
  ...
  if (!api)
    return (
      <div tw="mt-4 mb-4 flex flex-col items-center justify-center space-y-3 text-center font-mono text-sm text-gray-400 sm:(flex-row space-x-3 space-y-0)">
        <Spinner size="sm" />
        <div>
  ...
  return (
    <>
      <div tw="flex grow flex-col max-w-[20rem]">
